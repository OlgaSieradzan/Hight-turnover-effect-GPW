...
rates_10_5 = rate_of_return(prices_cleaned, result_10, 1, 10)
rates_10_5 = rate_of_return(prices_cleaned, result_20, 1, 20)
rates_10_5 = rate_of_return(prices_cleaned, result_50, 1, 50)

rates_10_5 = rate_of_return(prices_cleaned, result_10, 2, 10)
rates_10_5 = rate_of_return(prices_cleaned, result_20, 2, 20)
rates_10_5 = rate_of_return(prices_cleaned, result_50, 2, 50)

rates_10_5 = rate_of_return(prices_cleaned, result_10, 3, 10)
rates_10_5 = rate_of_return(prices_cleaned, result_20, 3, 20)
rates_10_5 = rate_of_return(prices_cleaned, result_50, 3, 50)

rates_10_5 = rate_of_return(prices_cleaned, result_10, 10, 10)
rates_10_5 = rate_of_return(prices_cleaned, result_20, 10, 20)
rates_10_5 = rate_of_return(prices_cleaned, result_50, 10, 50)
